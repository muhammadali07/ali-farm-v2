...
function SheepManager() {
    // Ensure sheepList typing is correct. db.sheep.find() returns Promise<Sheep[]>
    const [sheepList, setSheepList] = useState<Sheep[]>([]);
    const [filter] = useState<SheepStatus | 'ALL'>('ALL'); // Removed setFilter if unused or keep it
                ...
                <div className="lg:col-span-1">
                    {activeSheepData && (
                        <div className="bg-white rounded-xl border p-6 space-y-4">
                            <img src={activeSheepData.imageUrl} className="w-full h-40 object-cover rounded-xl" alt="Sheep" />
