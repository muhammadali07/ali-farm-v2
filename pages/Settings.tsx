...
import { Save, Globe, Database, Users, UserPlus, Mail, Edit2, Trash2, ShieldAlert, Loader2, BadgeCheck } from 'lucide-react';
                  ...
                  <tr key={u.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className={`text-[10px] font-bold px-2 py-0.5 rounded border ${
                        u.role === Role.OWNER ? 'bg-green-50 text-green-700 border-green-100' :
